...
var RestaurantRouter = function (server, opts, done) {
    server.get('/restaurants', function (request, reply) { return __awaiter(void 0, void 0, void 0, function () {
        var restaurantRepo, restaurant, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    restaurantRepo = restaurant_repo_1.RestaurantRepoImpl.of();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, restaurantRepo.getRestaurant()];
                case 2:
                    restaurant = _a.sent();
                    return [2 /*return*/, reply.status(200).send({ restaurant: restaurant })];
                case 3:
                    error_1 = _a.sent();
    ...
    server.post('/restaurants', function (request, reply) { return __awaiter(void 0, void 0, void 0, function () {
        var restaurantRepo, restaurantBody, restaurant, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    restaurantRepo = restaurant_repo_1.RestaurantRepoImpl.of();
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    restaurantBody = request.body;
                    return [4 /*yield*/, restaurantRepo.addRestaurant(restaurantBody)];
                case 2:
                    restaurant = _a.sent();
                    return [2 /*return*/, reply.status(201).send({ restaurant: restaurant })];
                case 3:
                    error_2 = _a.sent();
                    return [2 /*return*/, reply.status(500).send({ msg: 'Internal Server Error' })];
                case 4: return [2 /*return*/];
