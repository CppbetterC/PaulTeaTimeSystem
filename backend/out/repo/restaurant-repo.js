...
var RestaurantRepoImpl = /** @class */ (function () {
    ...
    RestaurantRepoImpl.prototype.getRestaurant = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // return Restaurant.fuzzySearch(name.toString())
                return [2 /*return*/, restaurant_1.default.find()];
            });
        });
    };
    RestaurantRepoImpl.prototype.addRestaurant = function (restaurantBody) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, restaurant_1.default.create(restaurantBody)];
            });
        });
    };
